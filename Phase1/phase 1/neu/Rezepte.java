...
public class Rezepte {
	...
	static final String XML = "../Phase1/phase 1/Aufgabe3/3a.xml";
	...
	public static void rezeptZeigen(RType rezept) {
		...
		if (rezept.getBrennwert() != null)
			System.out.println("Brennwert:" + " "
					+ rezept.getBrennwert().getWert() + " "
					+ rezept.getBrennwert().getEinheit() + "\n");
		...
		for (KType item : kommentare) {
			...
			if (item.getAvatar() != null)
				System.out.println(item.getAvatar().getBildadresse());
